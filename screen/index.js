    ...
    const dataVideo = [
        {
            ...
            sources: ["ReNzdtGH1B4"],
            "name": "Thanh Nhan",
            "thumb": require("../Images/images.png"),
            "videod": "300 Videos"
        },
        {
            "description": "Nhạc Chill TikTok | Kho Nhạc Lofi Chill Hay Nhất TikTok 2021",
            ...
            <ScrollView>
                ...
                <View style={styles.ViewName}>
                    <View style={styles.viewimagename}>
                        <View style={styles.viewimage}>
                            <Image style={styles.Image} source={require('../Images/images.png')}></Image>
                        </View>
                        <View style={styles.namevideo}>
                ...
                <View style={styles.viewComment}>
                    ...
                    <View style={styles.currentcomment}>
                        <Image style={styles.Imagecomment} source={require('../Images/images.png')}></Image>
                        <TextInput
